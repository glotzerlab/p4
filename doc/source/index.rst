...
#. to make it easy to see the effective shape of a rigid body's interaction
...
.. dropdown:: I am learning how to use HOOMD-blue.
   ...
   Learning to use p4 will help you learn to use HOOMD-blue. p4's API is much
   simpler and beginner-friendly than HOOMD-blue's, and most of p4's classes can
   be directly converted to HOOMD-blue equivalents.
   
   .. attention::
      
      In p4, interactions are currently confined to HOOMD-blue's Molecular
      Dynamics (MD) module, so if you are only interested in Monte Carlo methods
      then p4 will not be as helpful to you.
   ...
   To learn more about the differences between the p4 and HOOMD-blue APIs, read
   the section :ref:`creating-hoomd-blue-objects-from-p4`.
...
.. dropdown:: I am just curious about p4.

   Welcome! If you'd like to learn more about p4's purpose and motivation, read
   :ref:`project-goals`.

   If you are not a programmer, the user guide may still be interesting to
   you---all of the plots are interactive! Take a look at
   :ref:`specifying-particle-models`.

   If you are a programmer and you would like to learn more about the design of
   p4, read :ref:`for-developers`.
