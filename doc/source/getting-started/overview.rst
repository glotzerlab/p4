...
p4 is a package for creating and evaluating particle and interaction models,
...
Dynamics particle and interaction models. By providing a simple API for
measuring and visualizing energy, force, and torque fields, p4 makes it easy to
quickly evaluate existing models, develop new ones, and share those models with
others.