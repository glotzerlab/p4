...
Probe the effective potential landscape around a rigid body of particles using [HOOMD-blue](https://hoomd-blue.readthedocs.io/en/latest/).
...
field.plot()
```
![Plot of potential energy field around an LJ sphere](doc/assets/lj-sphere-plot.png)
...
```
![Plot of potential energy field around an attractive and repulsive alj cube](doc/assets/alj-cube-plot.png)
...
field.plot(fill_nan_with_inf=True)
```
![Plot of potential energy field around a repulsive alj cube with attractive gaussian sites](doc/assets/alj-cube-gauss-sites-plot.png)
